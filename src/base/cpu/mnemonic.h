...
typedef enum mnemonic_id_e {
    ...
    MNE_BMI, MNE_BNE, MNE_BPL, MNE_BRA, MNE_BRK, MNE_BRS, MNE_BVC, MNE_BVS,
    /* C */
    ...
    MNE_SAY, MNE_SBC, MNE_SBX, MNE_SEC, MNE_SED, MNE_SEI, MNE_SHA,
    ...
    MNE_TIN, MNE_TRB, MNE_TSB, MNE_TST, MNE_TSX, MNE_TXA, MNE_TXS, MNE_TYA,
    /* W */
    MNE_WAI
