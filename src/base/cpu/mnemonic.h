...
typedef enum mnemonic_id_e {
    ...
    MNE_BMI, MNE_BNE, MNE_BPL, MNE_BRA, MNE_BRK, MNE_BVC, MNE_BVS,
    /* C */
    MNE_CLC, MNE_CLD, MNE_CLI, MNE_CLV, MNE_CMP, MNE_CPX, MNE_CPY,
    /* D */
    ...
    /* S */
    MNE_SAX, MNE_SBC, MNE_SBX, MNE_SEC, MNE_SED, MNE_SEI, MNE_SHA, MNE_SHX,
    MNE_SHY, MNE_SLO, MNE_SMB, MNE_SMB0, MNE_SMB1, MNE_SMB2, MNE_SMB3,
    MNE_SMB4, MNE_SMB5, MNE_SMB6, MNE_SMB7, MNE_SRE, MNE_STA, MNE_STP, MNE_STX,
    MNE_STY, MNE_STZ,
    /* T */
    MNE_TAS, MNE_TAX, MNE_TAY, MNE_TRB, MNE_TSB, MNE_TSX, MNE_TXA, MNE_TXS,
    MNE_TYA,
    /* W */
    MNE_WAI
 ...
 */
#define MNEMONIC_COUNT   (MNE_TYA + 1)
